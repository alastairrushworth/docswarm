...
class TestGetChunkTool:
    ...
    def test_returns_not_found_message_for_missing_id(self, tools_by_name):
        result = tools_by_name["get_chunk"].invoke({"chunk_id": "00000000-ffff-0000-0000-000000000000"})
...
class TestGetPageStudyStatusTool:
    ...
    def test_shows_studied_after_study_logged(self, tools_by_name, sample_page, sample_document, db):
        db.log_page_study(
