...
def up() -> int:
    ...
    try:
        ...
        run_cmd = (
            ...
            # LLM provider is ever used: ANTHROPIC_BASE_URL forces every request to
            # local Ollama and ANTHROPIC_AUTH_TOKEN supplies the (ignored) local
            # credential, so even a stray real key in the environment cannot reach
            # a paid API.
